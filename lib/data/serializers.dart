...
BoulderingLog boulderingLogFromJson(Map<String, dynamic> json) => BoulderingLog(
...
bool _plannedExerciseIsCompoundWorkFromJson(Map<String, dynamic> json) {
  ...
  final pattern = MovementPattern.values.byName(json['pattern'] as String);
...
ExerciseState exerciseStateFromJson(Map<String, dynamic> j) => ExerciseState(
  ...
  lastTrainedDate: j['lastTrainedDate'] == null
      ? null
      : DateTime.parse(j['lastTrainedDate'] as String),
  consecutiveHoldCount: j['consecutiveHoldCount'] as int,
  regressionDates: (j['regressionDates'] as List)
      .map((e) => DateTime.parse(e as String))
      .toList(),
  painFrozen: j['painFrozen'] as bool,
  painSeverity: j['painSeverity'] == null
      ? null
      : PainSeverity.values.byName(j['painSeverity'] as String),
  painRegion: j['painRegion'] == null
      ? null
      : BodyRegion.values.byName(j['painRegion'] as String),
  painFlaggedDate: j['painFlaggedDate'] == null
      ? null
      : DateTime.parse(j['painFlaggedDate'] as String),
...
PainFlag painFlagFromJson(Map<String, dynamic> j) => PainFlag(
  ...
  tags: (j['tags'] as List)
      .map((t) => PainTag.values.byName(t as String))
      .toSet(),
);
...
CheckIn checkInFromJson(Map<String, dynamic> j) => CheckIn(
  ...
  pain: (j['pain'] as List)
      .map((e) => painFlagFromJson(e as Map<String, dynamic>))
      .toList(),
...
RecoverySnapshot recoverySnapshotFromJson(Map<String, dynamic> j) =>
    RecoverySnapshot(
      date: _parseDate(j['date'] as String),
...
CardioProtocol cardioProtocolFromJson(Map<String, dynamic> j) => CardioProtocol(
...
CardioPrescription cardioPrescriptionFromJson(Map<String, dynamic> j) =>
    CardioPrescription(
      protocol: cardioProtocolFromJson(j['protocol'] as Map<String, dynamic>),
      ...
      targetHeartRateMinBpm: (j['targetHeartRateMinBpm'] as num?)?.toDouble(),
      targetHeartRateMaxBpm: (j['targetHeartRateMaxBpm'] as num?)?.toDouble(),
...
CardioCompletion cardioCompletionFromJson(Map<String, dynamic> j) =>
    CardioCompletion(
      ...
      averageHeartRateBpm: (j['averageHeartRateBpm'] as num?)?.toDouble(),
...
SessionLog sessionLogFromJson(Map<String, dynamic> j) => SessionLog(
  ...
  setLogs: (j['setLogs'] as List)
      .map((e) => setLogFromJson(e as Map<String, dynamic>))
      .toList(),
  ...
  cardioCompletion: j['cardioCompletion'] == null
      ? null
      : cardioCompletionFromJson(j['cardioCompletion'] as Map<String, dynamic>),
  cardioCompletedAsPrescribed: j['cardioCompletedAsPrescribed'] as bool?,
  countsAs: (j['countsAs'] as List)
      .map((c) => FloorCategory.values.byName(c as String))
      .toSet(),
  rehitFinisherCompleted: j['rehitFinisherCompleted'] as bool? ?? false,
  isSupplemental:
      (j['isSupplemental'] as bool? ?? false) ||
...
QueueState queueStateFromJson(Map<String, dynamic> j) => QueueState(
  ...
  served: (j['served'] as List)
      .map((s) => SessionTypeId.values.byName(s as String))
      .toSet(),
);
...
EquipmentConfig equipmentConfigFromJson(Map<String, dynamic> j) =>
    EquipmentConfig(
      blocks: (j['blocks'] as List)
          .map(
            (b) => DumbbellBlock(
              ...
              perDumbbellSteps: (b['steps'] as List)
...
OuraConnection ouraConnectionFromJson(Map<String, dynamic> j) => OuraConnection(
  ...
  accessTokenExpiresAt: j['accessTokenExpiresAt'] == null
      ? null
      : DateTime.parse(j['accessTokenExpiresAt'] as String),
);
...
OneDriveConnection oneDriveConnectionFromJson(Map<String, dynamic> j) =>
    OneDriveConnection(
      accessToken: j['accessToken'] as String?,
      refreshToken: j['refreshToken'] as String?,
      accessTokenExpiresAt: j['accessTokenExpiresAt'] == null
      ...
      lastBackupAt: j['lastBackupAt'] == null
          ? null
          : DateTime.parse(j['lastBackupAt'] as String),
...
UserSettings userSettingsFromJson(Map<String, dynamic> j) => UserSettings(
  ...
  weeklyFloor: (j['weeklyFloor'] as Map<String, dynamic>).map(
    (k, v) => MapEntry(FloorCategory.values.byName(k), v as int),
  ),
  ...
  oura: j['oura'] == null
      ...
      : ouraConnectionFromJson(j['oura'] as Map<String, dynamic>),
  oneDrive: j['oneDrive'] == null
      ? const OneDriveConnection()
      : oneDriveConnectionFromJson(j['oneDrive'] as Map<String, dynamic>),
  ...
  secondRehitNudgeScheduledFor: _tryParseOptionalDateTime(
    j['secondRehitNudgeScheduledFor'],
  ),
  restDayRehitNudgeEnabled: j['restDayRehitNudgeEnabled'] as bool? ?? false,
  restDayRehitNudgeScheduledDay: j['restDayRehitNudgeScheduledDay'] as String?,
  restDayRehitNudgeScheduledFor: _tryParseOptionalDateTime(
    j['restDayRehitNudgeScheduledFor'],
  ),
...
Map<String, dynamic> lowerBackRecoveryStateToJson(
  ...
  'consecutiveToleratedSessions': state.consecutiveToleratedSessions,
  'recoverySessionDates': state.recoverySessionDates
      .map((date) => date.toIso8601String())
      .toList(),
  'pendingNextMorningSessionDate': state.pendingNextMorningSessionDate
      ?.toIso8601String(),
  ...
  'preRecoveryHingeLadderStepIndex': state.preRecoveryHingeLadderStepIndex,
...
LowerBackRecoveryState lowerBackRecoveryStateFromJson(
  ...
  return LowerBackRecoveryState(
    ...
    stage:
        enumValue(LowerBackRecoveryStage.values, json['stage']) ??
        LowerBackRecoveryStage.isometricHold,
    targetHoldSeconds: (json['targetHoldSeconds'] as num?)?.toInt() ?? 30,
    targetDynamicReps: (json['targetDynamicReps'] as num?)?.toInt() ?? 6,
    ...
    preRecoveryHingeLoad: (json['preRecoveryHingeLoad'] as num?)?.toDouble(),
...
PlannedExercise plannedExerciseFromJson(Map<String, dynamic> j) =>
    PlannedExercise(
      trackKey: j['trackKey'] as String,
      pattern: MovementPattern.values.byName(j['pattern'] as String),
      name: j['name'] as String,
      visualId: j['visualId'] as String?,
      sets: j['sets'] as int,
      metric: _exerciseMetricFromJson(j['metric']),
      targetRange: (
      ...
      progressionFraction: (j['progressionFraction'] as num?)?.toDouble(),
...
SessionPlan sessionPlanFromJson(Map<String, dynamic> j) => SessionPlan(
  ...
  exercises: (j['exercises'] as List)
      .map((e) => plannedExerciseFromJson(e as Map<String, dynamic>))
      .toList(),
  ...
  travelMode: j['travelMode'] as bool? ?? false,
  lowerBackRecoveryMode: j['lowerBackRecoveryMode'] as bool? ?? false,
...
) => {'minimum': band.minimum, 'center': band.center, 'maximum': band.maximum};

EffectiveSetTargetBand effectiveSetTargetBandFromJson(Map<String, dynamic> j) =>
...
Map<String, dynamic> trainingTargetsToJson(TrainingTargets targets) => {
  ...
  'hypertrophyTargetBands': targets.hypertrophyTargetBands.map(
    (group, band) => MapEntry(group.name, effectiveSetTargetBandToJson(band)),
  ),
  'hypertrophyEvaluationWindowDays': targets.hypertrophyEvaluationWindowDays,
  ...
  'preferredNorwegian4x4Exposures': targets.preferredNorwegian4x4Exposures,
  'baseAerobicRollingWindowDays': targets.baseAerobicRollingWindowDays,
...
TrainingTargets trainingTargetsFromJson(Map<String, dynamic> j) {
  ...
  return TrainingTargets(
    ...
    baseLongExposureCount:
        j['baseLongExposureCount'] as int? ?? defaults.baseLongExposureCount,
    baseLongExposureMinutes:
        j['baseLongExposureMinutes'] as int? ??
        defaults.baseLongExposureMinutes,
  );
}

Map<String, dynamic> muscleTrainingStatusToJson(MuscleTrainingStatus status) =>
    {
      ...
      'deficitToMinimumEffectiveSets': status.deficitToMinimumEffectiveSets,
    };

MuscleTrainingStatus muscleTrainingStatusFromJson(Map<String, dynamic> j) =>
    MuscleTrainingStatus(
      muscleGroup: MajorMuscleGroup.values.byName(j['muscleGroup'] as String),
      completedEffectiveSets: (j['completedEffectiveSets'] as num).toDouble(),
      minimumTargetEffectiveSets: (j['minimumTargetEffectiveSets'] as num)
          .toDouble(),
      centerTargetEffectiveSets: (j['centerTargetEffectiveSets'] as num)
          .toDouble(),
      maximumTargetEffectiveSets: (j['maximumTargetEffectiveSets'] as num)
          .toDouble(),
      deficitToMinimumEffectiveSets: (j['deficitToMinimumEffectiveSets'] as num)
          .toDouble(),
    );
...
AerobicTrainingStatus aerobicTrainingStatusFromJson(Map<String, dynamic> j) =>
...
TrainingStatus trainingStatusFromJson(Map<String, dynamic> j) => TrainingStatus(
  ...
  muscle: (j['muscle'] as List)
      .map(
        (item) =>
            muscleTrainingStatusFromJson((item as Map).cast<String, dynamic>()),
      )
      .toList(),
    ...
    candidates: (j['candidates'] as List)
        .map(
          (c) => ScoredCandidate(
            ...
            scoreTerms: (c['scoreTerms'] as Map).map(
              (k, v) => MapEntry(k as String, v as int),
            ),
          ),
        )
        .toList(),
    firedRules: (j['firedRules'] as List)
        .map((e) => firedRuleFromJson(e as Map<String, dynamic>))
        .toList(),
    plan: j['plan'] == null
        ? null
        : sessionPlanFromJson(j['plan'] as Map<String, dynamic>),
    restReason: j['restReason'] as String?,
    queue: QueueTraceInfo(
      pointerBefore: SessionTypeId.values.byName(q['pointerBefore'] as String),
      servedBefore: (q['servedBefore'] as List)
          .map((s) => SessionTypeId.values.byName(s as String))
          .toSet(),
      pointerAfterIfCompleted: q['pointerAfterIfCompleted'] == null
          ? null
          : SessionTypeId.values.byName(q['pointerAfterIfCompleted'] as String),
    ),
  );
}
